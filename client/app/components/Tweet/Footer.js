...
class Footer extends React.Component {
  ...
  render () {
    const {data, diseableFooterLink} = this.props

    return (
      <div className="footer" style={styles.footer}>
        <a className="ProfileTweet-actionList" style={styles.ProfileTweetActionList} href={!diseableFooterLink ? `http://twitter.com/${data.user.screen_name}/status/${data.id_str}` : ''}>
